...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        // Host Info
        $widget['total_hosts'] = Host::count();
        $widget['verified_hosts'] = Host::where('status', 1)->count();
        $widget['email_unverified_hosts'] = Host::where('ev', 0)->count();
        $widget['sms_unverified_hosts'] = Host::where('sv', 0)->count();
