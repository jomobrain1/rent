    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <a href="{{route('admin.dashboard')}}" class="sidebar__main-logo"><img
                    src="{{getImage(imagePath()['logoIcon']['path'] .'/pic.png')}}" alt="@lang('image')"></a>
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.type*')}}">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.hosts*',3)}}">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.hosts*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.hosts.all')}} ">
                                <a href="{{route('admin.hosts.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Hosts')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.hosts.active')}} ">
                                <a href="{{route('admin.hosts.active')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Active Hosts')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.hosts.banned')}} ">
                                <a href="{{route('admin.hosts.banned')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Banned Hosts')</span>
                            ...
                            <li class="sidebar-menu-item  {{menuActive('admin.hosts.email.unverified')}}">
                                <a href="{{route('admin.hosts.email.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.hosts.sms.unverified')}}">
                                <a href="{{route('admin.hosts.sms.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.hosts.email.all')}}">
                                <a href="{{route('admin.hosts.email.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.requests*',3)}}">
                        <i class="menu-icon las la-credit-card"></i>
                        <span class="menu-title">@lang('Withdrawal Requests')</span>
                        @if(0 < $pending_requests_count)
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.requests*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.requests.pending')}} ">
                                <a href="{{route('admin.requests.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Requests')</span>
                                    @if($pending_requests_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$pending_requests_count}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.requests.approved')}} ">
                                <a href="{{route('admin.requests.approved')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Requests')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.requests.rejected')}} ">
                                <a href="{{route('admin.requests.rejected')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rejected Requests')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.requests.successful')}} ">
                                <a href="{{route('admin.requests.successful')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Successful Requests')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.requests.list')}} ">
                                <a href="{{route('admin.requests.list')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
