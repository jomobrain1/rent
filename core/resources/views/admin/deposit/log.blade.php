...
<div class="row justify-content-center">
    ...
    || request()->routeIs('admin.hosts.deposits') || request()->routeIs('admin.hosts.deposits.method'))
                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Host')">
                                    <span class="font-weight-bold">{{ $deposit->host->name }}</span>
                                    <br>
                                    <span class="small">
                                    <a href="{{ route('admin.users.detail', $deposit->host_id) }}"><span>@</span>{{ $deposit->host->username }}</a>
                                    </span>
                                </td>
