            ...
            <div class="row justify-content-center">
                <div class="col-xxl-6 col-lg-8">
                    <div class="account__wrapper bg--section">
                        ...
                        <form class="account-form row g-4" method="POST" action="{{ route('host.login')}}" onsubmit="return submitUserForm();">
                            @csrf

                            <div class="col-md-12">
                                <label for="username" class="form--label">@lang('Email')</label>
                                <input type="text" name="username" value="{{ old('username') }}" placeholder="@lang('Email')" class="form-control form--control" required>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="d-flex flex-wrap justify-content-between">
                                    <a href="{{route('host.password.request')}}" class="text--base">@lang('Forgot Password?')</a>
                                    <div>
                                        @lang('New here?') <a href="{{ route('host.register') }}" class="text--base">@lang('Create Account')</a>
                                    </div>
                                </div>
                            </div>
                        </form>
