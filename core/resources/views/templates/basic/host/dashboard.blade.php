...
@section('content')
    ...
    <div class="pb-60 pt-60">
        <div class="row justify-content-center g-4">
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="dashboard__item p-4">
                    <div class="">
                        <a href="{{ route('host.vehicles.index') }}" class="cmn--btn"></><i class="las la-car-side"></i></a>
                        <span class="subtitle">Your Vehicles List</span>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="dashboard__item p-4">
                    <div class="">
                        <a href="{{ route('host.requests') }}" class="cmn--btn"></><i class="las la-wallet"></i></a>
                        <span class="subtitle">Your Wallet</span>
                    </div>
                </div>
            </div>
        </div>
